...
SEED_USERS = {
    ...
    "you_ruo_yi": {"id": "you_ruo_yi", "name": "游若誼", "role": "manager", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    ...
    "yang_jie_lin": {"id": "yang_jie_lin", "name": "楊傑麟", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "chu_pei_yu": {"id": "chu_pei_yu", "name": "褚佩瑜", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    ...
    "zhang_yi_chuan": {"id": "zhang_yi_chuan", "name": "張億峖", "role": "manager", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    ...
    "chen_gu_bin": {"id": "chen_gu_bin", "name": "陳谷濱", "role": "manager", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "chen_jing_ru": {"id": "chen_jing_ru", "name": "陳靜儒", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "lin_tian_jing": {"id": "lin_tian_jing", "name": "林天睛", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "lu_yi_qin": {"id": "lu_yi_qin", "name": "呂宜芹", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "yan_cheng_xi": {"id": "yan_cheng_xi", "name": "顏呈晞", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
    "gao_zhu_yu": {"id": "gao_zhu_yu", "name": "高竹妤", "role": "employee", "enabled": True, "password_hash": generate_password_hash("1234"), "password_temp": True},
}
